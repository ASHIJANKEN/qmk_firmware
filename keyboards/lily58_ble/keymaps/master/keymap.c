...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    CASE_US_AUTO_HANKAKU(CS_0, KEY(0), SHIFT_DU(KEY_SHIFT(9), KEY(0)));
    CASE_US_AUTO_HANKAKU(CS_1, KEY(1), KEY(1));
    CASE_US_AUTO_HANKAKU(CS_2, KEY(2), SHIFT_DU(KEY_UPSHIFT(LBRACKET), KEY(2)));
    CASE_US_AUTO_HANKAKU(CS_3, KEY(3), KEY(3));
    CASE_US_AUTO_HANKAKU(CS_4, KEY(4), KEY(4));
    CASE_US_AUTO_HANKAKU(CS_5, KEY(5), KEY(5));
    CASE_US_AUTO_HANKAKU(CS_6, KEY(6), SHIFT_DU(KEY_UPSHIFT(EQUAL), KEY(6)));
    CASE_US_AUTO_HANKAKU(CS_7, KEY(7), SHIFT_DU(KEY_SHIFT(6), KEY(7)));
    CASE_US_AUTO_HANKAKU(CS_8, KEY(8), SHIFT_DU(KEY_SHIFT(QUOTE), KEY(8)));
    CASE_US_AUTO_HANKAKU(CS_9, KEY(9), SHIFT_DU(KEY_SHIFT(8), KEY(9)));
    CASE_US_AUTO_HANKAKU(MY_DEL, KEY(DELETE), KEY_UPSHIFT(BSPACE));
    CASE_US_AUTO_HANKAKU(MY_TILD, KEY_SHIFT(GRAVE), KEY_SHIFT(EQUAL));
    CASE_US_AUTO_HANKAKU(MY_BKKR, KEY_SHIFT(1), KEY_SHIFT(1));
    CASE_US_AUTO_HANKAKU(MY_AT, KEY_SHIFT(2), KEY(LBRACKET));
    CASE_US_AUTO_HANKAKU(MY_HASH, KEY_SHIFT(3), KEY_SHIFT(3));
    CASE_US_AUTO_HANKAKU(MY_DLR, KEY_SHIFT(4), KEY_SHIFT(4));
    CASE_US_AUTO_HANKAKU(MY_PERC, KEY_SHIFT(5), KEY_SHIFT(5));
    CASE_US_AUTO_HANKAKU(MY_CIRC, KEY_SHIFT(6), KEY(EQUAL));
    CASE_US_AUTO_HANKAKU(MY_AMPR, KEY_SHIFT(7), KEY_SHIFT(6));
    CASE_US_AUTO_HANKAKU(MY_ASTR, KEY_SHIFT(8), KEY_SHIFT(QUOTE));
    CASE_US_AUTO_HANKAKU(MY_LPRN, KEY_SHIFT(9), KEY_SHIFT(8));
    CASE_US_AUTO_HANKAKU(MY_RPRN, KEY_SHIFT(0), KEY_SHIFT(9));
    CASE_US_AUTO_HANKAKU(MY_LBRC, KEY(LBRACKET), SHIFT_DU(KEY_SHIFT(RBRACKET), KEY(RBRACKET)));
    CASE_US_AUTO_HANKAKU(MY_RBRC, KEY(RBRACKET), SHIFT_DU(KEY_SHIFT(NONUS_HASH), KEY(NONUS_HASH)));
    CASE_US_AUTO_HANKAKU(MY_LCBR, KEY_SHIFT(LBRACKET), KEY_SHIFT(RBRACKET));
    CASE_US_AUTO_HANKAKU(MY_RCBR, KEY_SHIFT(RBRACKET), KEY_SHIFT(NONUS_HASH));
    CASE_US_AUTO_HANKAKU(MY_GRV, KEY(GRAVE), SHIFT_DU(KEY_SHIFT(EQUAL), KEY_SHIFT(LBRACKET)));
    CASE_US_AUTO_HANKAKU(MY_BSLS, KEY(BSLASH), SHIFT_DU(KEY_SHIFT(INT3), KEY(INT3)));
    CASE_US_AUTO_HANKAKU(MY_PIPE, KEY_SHIFT(BSLASH), KEY_SHIFT(INT3));
    CASE_US(MY_MINS, KEY(MINUS), SHIFT_DU(KEY_SHIFT(INT1), KEY(MINUS)));
    CASE_US_AUTO_HANKAKU(MY_UNDS, KEY_SHIFT(MINUS), KEY_SHIFT(INT1));
    CASE_US_AUTO_HANKAKU(MY_EQL, KEY(EQUAL), SHIFT_DU(KEY_SHIFT(SCOLON), KEY_SHIFT(MINUS)));
    CASE_US_AUTO_HANKAKU(MY_PLUS, KEY_SHIFT(EQUAL), KEY_SHIFT(SCOLON));
    CASE_US_AUTO_HANKAKU(MY_SCLN, KEY(SCOLON), SHIFT_DU(KEY_UPSHIFT(QUOTE), KEY(SCOLON)));
    CASE_US_AUTO_HANKAKU(MY_QUOT, KEY(QUOTE), SHIFT_DU(KEY_SHIFT(2), KEY_SHIFT(7)));
    case BT_ID0 ... BT_ID7:
      // The code is based on tmk_core/protocol/nrf/bmp.c
